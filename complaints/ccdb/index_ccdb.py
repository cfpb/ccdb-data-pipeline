...
def index_json_data(es, logger, doc_type_name, settings_json, mapping_json, data, index_name, backup_index_name, alias, chunk_size=20000):
    ...
    try:
        ...
        update_indexes_in_alias(es, logger, alias, backup_index_name, index_name)
